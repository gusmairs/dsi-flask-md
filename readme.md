...
Running in the Flask development environment auto-reloads the server with changes to the code files. The default port is 127.0.0.1:5000. `<Ctrl-C>` in the terminal window to kill the process.
